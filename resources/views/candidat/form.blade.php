        ...
        @if ($step == 1)
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="nom_ar" class="form-control" id="nom_ar" placeholder="الاسم العائلي بالعربية" value="{{ old('nom_ar', $data['nom_ar'] ?? '') }}" required dir="rtl">
                    @error('nom_ar') <span class="text-danger">{{ $message }}</span> @enderror
                </div>
                <div class="col-md-6 mb-3">
                    <label for="prenom_ar">الاسم الشخصي بالعربية</label>
                    <input type="text" name="prenom_ar" class="form-control" id="prenom_ar" placeholder="الاسم الشخصي بالعربية" value="{{ old('prenom_ar', $data['prenom_ar'] ?? '') }}" required dir="rtl">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="ville_naissance" class="form-control" id="ville_naissance" placeholder="Entrez votre ville de naissance" value="{{ old('ville_naissance', $data['ville_naissance'] ?? '') }}" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="ville_naissance_ar" class="form-control" id="ville_naissance_ar" placeholder="مدينة الازدياد بالعربية" value="{{ old('ville_naissance_ar', $data['ville_naissance_ar'] ?? '') }}" required dir="rtl">
        ...
        @if ($step == 2)
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="serie_bac" class="form-control" id="serie_bac" placeholder="Série du Bac" value="{{ old('serie_bac', $data['serie_bac'] ?? '') }}" required>
                    ...
                    <div class="diplome-form mb-4 p-3 border rounded">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="diplomes[{{ $index }}][type_diplome_bac_2]" class="form-control" id="type_diplome_bac_2_{{ $index }}" placeholder="Type Diplôme Bac+2" value="{{ old('diplomes.' . $index . '.type_diplome_bac_2', $diplome['type_diplome_bac_2'] ?? '') }}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="diplomes[{{ $index }}][annee_diplome_bac_2]" class="form-control" id="annee_diplome_bac_2_{{ $index }}" required>
                                    <option value="">Veuillez sélectionner</option>
                                    @for ($i = now()->year; $i >= 2000; $i--)
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="diplomes[{{ $index }}][filier_diplome_bac_2]" class="form-control" id="filier_diplome_bac_2_{{ $index }}" placeholder="Filière Bac+2" value="{{ old('diplomes.' . $index . '.filier_diplome_bac_2', $diplome['filier_diplome_bac_2'] ?? '') }}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="file" name="diplomes[{{ $index }}][scan_bac_2]" class="form-control" id="scan_bac_2_{{ $index }}" accept=".jpg,.jpeg,.png,.pdf" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="diplomes[{{ $index }}][etablissement_bac_2]" class="form-control" id="etablissement_bac_2_{{ $index }}" placeholder="Établissement Bac+2" value="{{ old('diplomes.' . $index . '.etablissement_bac_2', $diplome['etablissement_bac_2'] ?? '') }}" required>
        ...
        diplomeDiv.innerHTML = `
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="diplomes[${diplomeCount}][type_diplome_bac_2]" class="form-control" id="type_diplome_bac_2_${diplomeCount}" placeholder="Type Diplôme Bac+2" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label for="annee_diplome_bac_2_${diplomeCount}">Année Bac+2</label>
                    <select name="diplomes[${diplomeCount}][annee_diplome_bac_2]" class="form-control" id="annee_diplome_bac_2_${diplomeCount}" required>
                        <option value="">Veuillez sélectionner</option>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="diplomes[${diplomeCount}][filier_diplome_bac_2]" class="form-control" id="filier_diplome_bac_2_${diplomeCount}" placeholder="Filière Bac+2" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label for="scan_bac_2_${diplomeCount}">Scan Bac+2</label>
                    <input type="file" name="diplomes[${diplomeCount}][scan_bac_2]" class="form-control" id="scan_bac_2_${diplomeCount}" accept=".jpg,.jpeg,.png,.pdf" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label for="etablissement_bac_2_${diplomeCount}">Établissement Bac+2</label>
                    <input type="text" name="diplomes[${diplomeCount}][etablissement_bac_2]" class="form-control" id="etablissement_bac_2_${diplomeCount}" placeholder="Établissement Bac+2" required>
                </div>
                <div class="col-md-6 mb-3">
