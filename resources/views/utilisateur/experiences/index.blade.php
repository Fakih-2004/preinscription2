                        ...
                        <table id="experienceTable" class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="text-xs font-weight-bold mb-0 text-truncate" style="max-width: 200px;">{{ $experience->discription }}</p>
                                    </td>
                                    <td>
                                    ...
                                    <td class="align-center text-end pe-4">
                                        <a href="{{ route('experiences.edit', $experience->id) }}" class="text-secondary font-weight-bold text-xs me-2">
                                            <i class="material-symbols-rounded">edit</i>
                                        </a>
                                        <form id="delete-form-{{ $experience->id }}" action="{{ route('experiences.destroy', $experience->id) }}" method="POST" style="display: inline-block;">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button" class="btn btn-link text-danger font-weight-bold text-xs p-0" onclick="confirmDelete({{ $experience->id }})">
