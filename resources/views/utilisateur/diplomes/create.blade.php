                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-outline my-3 is-filled">
                                    ...
                                    <input type="text" name="type_diplome_bac2" class="form-control" placeholder="Entrez le type de diplôme Bac+2" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-outline my-3 is-filled">
                                    <label class="form-label">Année Bac+2</label>
                                                                        <input type="text" name="annee_bac2" class="form-control" placeholder="Entrez le annee de diplôme Bac+2" required>
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-outline my-3 is-filled">
                                    ...
                                    <input type="text" name="filiere_bac2" class="form-control" placeholder="Entrez la filière Bac+2" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-outline my-3 is-filled">
                                    ...
                                    <input type="text" name="etalissement_bac2" class="form-control" placeholder="Entrez l'établissement Bac+2" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-outline my-3 is-filled">
                                    ...
                                    <input type="file" name="scan_bac2" class="form-control" accept="application/pdf,image/*" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-outline my-3 is-filled">
                                    ...
                                    <input type="text" name="type_bac3" class="form-control" placeholder="Entrez le type de diplôme Bac+3" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-outline my-3 is-filled">
                                    <label class="form-label">Année Bac+3</label>
                                                                        <input type="text" name="annee_bac3" class="form-control" placeholder="Entrez le annee de diplôme Bac+2" required>
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-outline my-3 is-filled">
                                    ...
                                    <input type="text" name="filiere_bac3" class="form-control" placeholder="Entrez la filière Bac+3" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-outline my-3 is-filled">
                                    ...
                                    <input type="text" name="etablissement_bac3" class="form-control" placeholder="Entrez l'établissement Bac+3" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-outline my-3 is-filled">
                                    ...
                                    <input type="file" name="scan_bac3" class="form-control" accept="application/pdf,image/*" required>
                                </div>
                            </div>
